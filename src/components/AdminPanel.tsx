...
export const AdminPanel: React.FC<AdminPanelProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'publicar' | 'imoveis' | 'publicidade' | 'conversas' | 'backup'>('publicar');
    ...
    try {
      ...
      setPublishStatus({ 
        ...
        message: editingPropertyId 
          ? 'Imóvel atualizado com sucesso! Sincronizado para todos os visitantes.' 
          : 'Novo anúncio publicado com sucesso! Visível para todos os visitantes em tempo real.' 
      });
      onPropertiesUpdated();
      resetForm();
    } catch (err: any) {
      setPublishStatus({ 
        type: 'error', 
        message: `Erro ao processar: ${err?.message || 'Tente novamente.'}` 
      });
    } finally {
      setIsSaving(false);
    }
